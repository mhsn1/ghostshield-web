    ...
    <div style={{ minHeight: '100vh', background: '#000', display: 'flex',
      ...
      <div style={{ width: '100%', maxWidth: '400px', padding: '0 24px' }}>
        ...
        <div style={{ background: '#0a0a0a', border: '1px solid rgba(255,255,255,0.07)',
          ...
          {/* Toggle */}
          <div style={{ display: 'flex', background: '#111', borderRadius: '8px',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            {error && <div style={{ fontSize: '13px', color: '#ff4444', padding: '8px 12px',
              background: 'rgba(255,68,68,0.08)', borderRadius: '6px' }}>{error}</div>}
            {message && <div style={{ fontSize: '13px', color: '#00c853', padding: '8px 12px',
              background: 'rgba(0,200,83,0.08)', borderRadius: '6px' }}>{message}</div>}
